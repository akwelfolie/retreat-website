      ...
      <div className="mx-auto mt-12 grid max-w-xl gap-10 lg:mt-16 lg:max-w-none lg:grid-cols-3 lg:gap-x-12">
        {steps.slice(0, 3).map((step, index) => (
          <div key={`service-process-setp-${index}`} className="w-full">
            <span className="size-18 bg-linear-to-r from-dark-600 to-dark-700 mx-auto flex items-center justify-center rounded-3xl shadow-xl">
              {/* TablerIcon name: clipboard-list */}
              <step.icon className="text-dark-300 h-10 w-10" stroke={1.5} />
            </span>
